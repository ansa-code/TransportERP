...
<div class="vehicle-form-page">
    ...
    <div class="vehicle-form-card">
        ...
        <div class="vehicle-form-header">
            ...
            <p>Create a vehicle profile using the required vehicle information.</p>
        ...
        <form action="{{ route('vehicles.store') }}" method="POST">
            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    <select name="vehicle_type" class="form-control" required>
                        ...
                        <option value="Heavy Truck"
                            {{ old('vehicle_type') == 'Heavy Truck' ? 'selected' : '' }}>
                            Heavy Truck
                        </option>

                        <option value="Small Truck"
                            {{ old('vehicle_type') == 'Small Truck' ? 'selected' : '' }}>
                            Small Truck
                        </option>
                        ...
                        <option value="Pickup"
                            {{ old('vehicle_type') == 'Pickup' ? 'selected' : '' }}>
                            Pickup
                        </option>

                        <option value="Trailer"
                            {{ old('vehicle_type') == 'Trailer' ? 'selected' : '' }}>
                            Trailer
                        </option>
                ...
                <div class="form-group">
                    ...
                    <div class="input-row">
                        ...
                        <select
                            ...
                            <option value="KG"
                                {{ old('load_capacity_unit') == 'KG' ? 'selected' : '' }}>
                                KG
                            </option>

                            <option value="TON"
                                {{ old('load_capacity_unit') == 'TON' ? 'selected' : '' }}>
                                Ton
                            </option>
                ...
                <div class="form-group">
                    ...
                    <select
                        ...
                        <option value="Company Owned"
                            {{ old('ownership_type') == 'Company Owned' ? 'selected' : '' }}>
                            Company Owned
                        </option>

                        <option value="Hired"
                            {{ old('ownership_type') == 'Hired' ? 'selected' : '' }}>
                            Hired
                        </option>

                        <option value="Financed"
                            {{ old('ownership_type') == 'Financed' ? 'selected' : '' }}>
                            Financed
                        </option>

                        <option value="Other"
                            {{ old('ownership_type') == 'Other' ? 'selected' : '' }}>
                            Other
                        </option>
                ...
                <div class="form-group">
                    ...
                    <label>
                        Vendor / Owner
                        <span id="vendor-required" class="required" style="display:none;">*</span>
                    </label>
                ...
                <div class="form-group">
                    ...
                    <label>
                        Bank Instalment Amount
                        <span id="instalment-required" class="required" style="display:none;">*</span>
                    </label>
                    ...
                    <input
                        ...
                        value="{{ old('bank_instalment_amount') }}"
                        class="form-control"
                        min="0"
                        step="0.01"
                    >
                ...
                <div class="form-group">
                    ...
                    <label>
                        Instalment Duration
                        <span id="duration-required" class="required" style="display:none;">*</span>
                    </label>
                    ...
                    <div class="input-row">
                        ...
                        <select
                            ...
                            <option value="Months"
                                {{ old('instalment_duration_unit', 'Months') == 'Months' ? 'selected' : '' }}>
                                Months
                            </option>

                            <option value="Years"
                                {{ old('instalment_duration_unit') == 'Years' ? 'selected' : '' }}>
                                Years
                            </option>
            ...
            <div class="form-actions">
                ...
                <a href="{{ route('vehicles.index') }}" class="cancel-btn">
                    Cancel
                </a>
