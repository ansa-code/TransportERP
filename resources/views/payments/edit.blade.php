        ...
        <div class="payment-form-card">
            ...
            <div class="form-section">
                ...
                <div class="current-payment-box">
                    ...
                    <div class="current-payment-item">

                        <div class="current-payment-label">
                            Current Paid Amount
                        </div>
            ...
            <div class="form-section">
                ...
                <p class="section-description">
                    Update the amount allocated to each invoice.
                    Blank allocation fields will be ignored.
                </p>
                            ...
                            <tbody>
                                ...
                                @foreach($invoices as $invoice)
                                    ...
                                    @php
                                        ...
                                        $existingAmount = $existingAllocation
                                            ? (float) $existingAllocation->allocated_amount
                                            : 0;

                                        $availableForThisPayment =
                                    ...
                                    >
                                        ...
                                        <td>
                                            ...
                                            <span class="invoice-balance">
                                                {{ number_format($availableForThisPayment, 2) }}
                                            </span>
                                        ...
                                        <td>
                                            ...
                                            <input
                                                ...
                                                min="0"
                                                max="{{ $availableForThisPayment }}"
                                                step="0.01"
                                                value="{{ old(
                                                    'allocations.' . $invoice->id . '.allocated_amount',
                                                    $existingAmount > 0 ? $existingAmount : ''
                                                ) }}"
                                                data-balance="{{ $availableForThisPayment }}"
                                                placeholder="0.00"
                                            >

                                            @if($existingAmount > 0)

                                                <span class="current-allocation">
                                                    Current: {{ number_format($existingAmount, 2) }}
                                                </span>
                ...
                @else
                    ...
                    <div class="no-invoices">
                        No invoices are available for allocation.
                    </div>
