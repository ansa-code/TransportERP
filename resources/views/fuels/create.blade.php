...
<div class="fuel-create-page">

    <div class="page-header">
        <div>
            <h1>Add Fuel Record</h1>
            <p>Record vehicle fuel usage, cost and client reimbursement details.</p>
        </div>
    </div>
    ...
    >
        ...
        <div class="form-card">
            ...
            <p class="section-subtitle">
                Enter the basic fuel transaction and operational context.
            </p>
            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    <input
                        ...
                        id="fuel_date"
                        class="form-control"
                        value="{{ old('fuel_date', now()->format('Y-m-d\TH:i')) }}"
        ...
        <div class="form-card">
            ...
            <p class="section-subtitle">
                Enter quantity and pricing details. Total Cost is calculated automatically.
            </p>
            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    >
                        ...
                        <option
                            value="AL SHAQRA"
                            {{ old('paid_by', 'AL SHAQRA') == 'AL SHAQRA' ? 'selected' : '' }}
                        >
                            AL SHAQRA
                        </option>
        ...
        <div class="form-card">
            ...
            <p class="section-subtitle">
                Mark reimbursable fuel separately for client recovery reporting.
            </p>
                ...
                <div class="form-grid">
                    ...
                    >
                        ...
                        <input
                            ...
                            class="form-control"
                            value="{{ old('reimbursement_amount') }}"
                            min="0.01"
                            step="0.01"
                            placeholder="0.00"
                        >
        ...
        <div class="form-card">
            ...
            <p class="section-subtitle">
                Attach the fuel receipt and add any relevant notes.
            </p>
