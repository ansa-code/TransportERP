...
<div class="leave-form-page">
    ...
    <div class="page-header">
        ...
        <div>
            <h1 class="page-title">Edit Leave</h1>

            <p class="page-subtitle">
                Update driver leave details and approval information
            </p>
        </div>
    ...
    <div class="form-card">
        ...
        <p class="section-subtitle">
            Update the leave record using the fields below.
        </p>
        ...
        >
            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    >
                        ...
                        @foreach($drivers as $driver)
                            ...
                            <option
                                value="{{ $driver->id }}"
                                {{ old('driver_id', $leave->driver_id) == $driver->id ? 'selected' : '' }}
                            >
                                {{ $driver->driver_name }}
                ...
                <div class="form-group">
                    ...
                    >
                        ...
                        <option
                            value="Annual"
                            {{ old('leave_type', $leave->leave_type) === 'Annual' ? 'selected' : '' }}
                        >
                            Annual
                        </option>
                        ...
                        <option
                            value="Unpaid"
                            {{ old('leave_type', $leave->leave_type) === 'Unpaid' ? 'selected' : '' }}
                        >
                            Unpaid
                        </option>
                        ...
                        <option
                            value="Other"
                            {{ old('leave_type', $leave->leave_type) === 'Other' ? 'selected' : '' }}
                        >
                            Other
                        </option>
                ...
                <div class="form-group">
                    ...
                    >
                        ...
                        <option
                            value="Pending"
                            {{ old('approval_status', $leave->approval_status) === 'Pending' ? 'selected' : '' }}
                        >
                            Pending
                        </option>
                        ...
                        <option
                            value="Approved"
                            {{ old('approval_status', $leave->approval_status) === 'Approved' ? 'selected' : '' }}
                        >
                            Approved
                        </option>
                        ...
                        <option
                            value="Rejected"
                            {{ old('approval_status', $leave->approval_status) === 'Rejected' ? 'selected' : '' }}
                        >
                            Rejected
                        </option>
                        ...
                        <option
                            value="Cancelled"
                            {{ old('approval_status', $leave->approval_status) === 'Cancelled' ? 'selected' : '' }}
                        >
                            Cancelled
                        </option>
                ...
                <div class="form-group">
                    ...
                    >
                        ...
                        @foreach($drivers as $driver)
                            ...
                            <option
                                value="{{ $driver->id }}"
                                {{ old('replacement_driver_id', $leave->replacement_driver_id) == $driver->id ? 'selected' : '' }}
                            >
                                {{ $driver->driver_name }}
                                @if($driver->driver_code)
                                    — {{ $driver->driver_code }}
                ...
                <div class="form-group full-width">
                    ...
                    >{{ old('approval_notes', $leave->approval_notes) }}</textarea>
            ...
            <div class="approval-box">
                ...
                <p class="approval-box-text">
                    Update the approval status. Rejected leaves must include approval notes.
                </p>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const approvalStatus =
            document.getElementById('approval_status');

        const approvalNotes =
            document.getElementById('approval_notes');

        const approvalNotesHelp =
            document.getElementById('approval-notes-help');

        const statusMessage =
            document.getElementById('approval-status-message');
        ...
        const replacementSelect =
            document.getElementById('replacement_driver_id');

        function preventSameDriver() {
            ...
            if (
                replacementSelect.value === driverId
            ) {
